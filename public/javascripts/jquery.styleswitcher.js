...
if($.cookie("theme")) {
	...
	$("link.theme").attr("href",("/stylesheets/theme/" + $.cookie("theme") + ".css"));
};

// Checks if you've set a width already
if($.cookie("width")) {
	// Sets the width that the cookie finds
	$("link.width").attr("href",("/stylesheets/" + $.cookie("width") + ".css"));
};
...
$(document).ready(function() { 
	...
	$("#style li a").click(function() { 
		...
		var $theme = "/stylesheets/theme/" + ($(this).attr('href').replace("#","")) + ".css";
...
//-------------------------------------------------------------- */
	...
	$("#width li a").click(function() { 
		...
		var $widthCss = "/stylesheets/" + ($(this).attr('href').replace("#","")) + ".css";

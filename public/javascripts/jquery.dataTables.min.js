...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Verarbeiten...",sLengthMenu:"Zeige _MENU_ Eintr&auml;ge",sZeroRecords:"Keine Eintr&auml;ge gefunden",sEmptyTable:"Keine Eintr&auml;ge vorhanden",
sLoadingRecords:"Lade...",sInfo:"Zeige _START_ bis _END_ von _TOTAL_ Eintr&auml;gen",sInfoEmpty:"Zeige 0 bis 0 von 0 Eintr&auml;gen",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"Suche:",sUrl:"",oPaginate:{sFirst:"Erste",sPrevious:"Zur&uuml;ck",sNext:"Vor",sLast:"Letzte"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",bRegex:false,
